...
import img from "../../assets/lounge-stylized-inscriptions.png";
...
import { pessoas, empresas } from "../../utils/types";
...
function Empresas() {
  ...
  const { mutate } = useMutation(DeletEmpresas, {
    onSuccess: () => {
    ...
    <div className=" w-full flex flex-col  min-h-full p-2 bg-white relative ">
      ...
      <div className=" w-full  h-10">
        <div className=" w-full  flex items-center ">
          <Button
            variant="contained"
            className=" w-full max-w-[400px]  bg-[#00C5FF] hover:bg-[#C1FAFF]"
            onClick={() => {
              setOpen(true);
              ...
              <TableRow>
                <TableCell>
                  <div className=" w-full flex items-center ">
                    ...
                    <User size={23} weight="bold" color="#00C5FF" />
                  </div>
                </TableCell>
                <TableCell>
                  <div className=" w-full flex items-center ">
                    <span className=" mr-2 text-base">Contato</span>
                    <AddressBook size={25} weight="bold" color="#00C5FF" />
                  </div>
                </TableCell>
                <TableCell>
                  <div className=" w-full flex items-center ">
                    <span className=" mr-2 text-base">Opções</span>
                    <Option size={25} weight="bold" color="#00C5FF" />
                  </div>
                </TableCell>
              </TableRow>
            </TableHead>
        ...
        {(data?.data?.length as unknown as number) <= 0 || !data ? (
          <div className=" w-full flex flex-col items-center justify-center  h-[300px] mt-[100px]  rounded-sm ">
            ...
            <span className=" md:text-[20px] text-[10px] mt-5  text-[#42493A]">
              Adicione Empresas para conseguir ver a lista das mesmas!
            </span>
          </div>
        ) : null}
      </div>
